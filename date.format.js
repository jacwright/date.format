(function() {
	// Checking for locale month and day names
	if(typeof locale !== 'undefined'){
		Date.shortMonths = locale.shortMonths;
		Date.longMonths = locale.longMonths;
		Date.shortDays = locale.shortDays;
		Date.longDays = locale.longDays;
	}else{
